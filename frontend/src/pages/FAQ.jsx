...
const DEFAULT_FAQ_LIST = [
    ...
    },
    {
        ...
        answer:
            '문제 풀이 기록, 오답노트, 게시판 이용 기록을 개인별로 저장하기 위해 로그인이 필요합니다.\n' +
    ...
    },
    {
        ...
        answer:
            ...
            '점수 확인은 마지막으로 제출한 결과를 기준으로 보는 것이 가장 정확합니다.',
    },
    ...
    },
    {
        ...
        answer:
            ...
            '여러 답안을 쉼표(,) 또는 줄바꿈으로 구분해 입력하면 각 항목을 나누어 채점하고, 쉼표가 빠져도 핵심 용어 포함 여부를 최대한 확인합니다.\n' +
    ...
    // 최근 패치로 바뀐 주요 이용 흐름 안내입니다.
    // 기존 item 번호를 유지하기 위해 새 FAQ는 뒤에만 추가합니다.
    {
        category: '계정/로그인',
        question: '회원가입 후 바로 로그인할 수 있나요?',
        answer:
            '신규 회원가입은 관리자 승인 후 이용할 수 있습니다.\n' +
            '승인되면 가입한 이메일로 승인 안내가 발송되고, 거절된 경우에는 거절 사유가 함께 안내됩니다.\n' +
            '기존 회원은 별도 승인 절차 없이 이전처럼 계속 이용할 수 있습니다.',
    },
    {
        category: '필기/실기 문제은행',
        question: '문제은행 랜덤 문제는 같은 문제가 바로 반복되나요?',
        answer:
            '문제은행은 최근에 푼 문제와 과목을 우선 피해서 다음 문제를 가져오도록 개선되었습니다.\n' +
    ...
    },
    {
        ...
        answer:
            '상단의 밝기 슬라이더로 10%부터 100%까지 10% 단위로 조절할 수 있습니다.\n' +
