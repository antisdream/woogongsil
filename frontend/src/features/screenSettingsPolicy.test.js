...
test('retired screen sections match the server policy after trimming and case normalization', () => {
    for (const section of ['live_chat', 'chat_popup', 'score_ranking', 'ranking_history', 'ranking']) {
...
test('online visitors, personal result labels and unrelated settings remain available', () => {
    for (const section of ['online_users', 'result', 'hero', 'ranking_help']) {
